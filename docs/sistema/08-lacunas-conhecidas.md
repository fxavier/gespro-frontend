...
| M | Sem UI para sangria, reforço, cancelar sessão, pagamento/vencimento de factura, liquidar/cancelar NC ([#146](https://github.com/fxavier/gespro-frontend/issues/146)) ([#147](https://github.com/fxavier/gespro-frontend/issues/147)) ([#148](https://github.com/fxavier/gespro-frontend/issues/148)) |
...
| B | `/caixa/fechamento` ignora `?sessaoId=`; falta MT 500/1000 na contagem; links para `/faturacao/nota-credito/[id]` inexistentes ([#150](https://github.com/fxavier/gespro-frontend/issues/150)) ([#151](https://github.com/fxavier/gespro-frontend/issues/151)) ([#152](https://github.com/fxavier/gespro-frontend/issues/152)) |
| — | ~~DFC sem UI~~ — **deixou de ser lacuna** (2026-09-26, grafo `dfc`): `/contabilidade/dfc` e `/contabilidade/fluxo-caixa/rubricas` entregues. A [#153](https://github.com/fxavier/gespro-frontend/issues/153) continua aberta até ao **parecer contabilístico** `[HUMANO]` sobre o mapeamento (ticket 11); até lá, a DFC mostra «Mapeamento por validar» |
