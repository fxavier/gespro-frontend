...
export default function EditarRequisicaoPage() {
  ...
  const salvarRequisicao = (status: 'rascunho' | 'pendente') => {
    ...
    try {
      ...
      const requisicaoAtualizada: RequisicaoCompra = {
        ...requisicoes[index],
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-3xl font-bold">Editar Requisição de Compra</h1>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200">
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                ...
                <li>As alterações serão salvas e a requisição será atualizada</li>
              </ul>
            </div>
          </div>
        </CardContent>
