...
export default function NovaFaturaPage() {
  ...
  const clientesFiltrados = useMemo(() => {
    return clientesMock.filter((c) =>
      c.nome.toLowerCase().includes(buscaCliente.toLowerCase()) || c.nuit.includes(buscaCliente)
    );
  }, [buscaCliente]);
  ...
  const calcularTotais = () => {
    ...
    const descontoTotal =
      tipoDesconto === 'percentual' ? subtotal * (descontoGeral / 100) : descontoGeral;
  ...
  const handleGerarFatura = () => {
    ...
    setTimeout(() => router.push('/vendas/faturas'), 1500);
  };
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => router.push('/vendas/faturas')}>
            <X className="h-4 w-4 mr-2" />
            Cancelar
          </Button>
          <Button onClick={handleGerarFatura} disabled={!clienteSelecionado || itens.length === 0}>
          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Button size="sm" onClick={() => setDialogProdutoAberto(true)}>
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="border-t pt-3">
                  ...
                  <div className="flex gap-2 mb-2">
                    <Select value={tipoDesconto} onValueChange={(value: any) => setTipoDesconto(value)}>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Button className="w-full" onClick={handleGerarFatura} disabled={!clienteSelecionado || itens.length === 0}>
                <FileText className="h-4 w-4 mr-2" />
                Gerar Fatura
              </Button>
              <Button variant="outline" className="w-full" onClick={handleGerarFatura} disabled={!clienteSelecionado || itens.length === 0}>
                <Save className="h-4 w-4 mr-2" />
                Guardar Rascunho
              </Button>
            </CardContent>
