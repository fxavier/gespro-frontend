...
const menuItems: MenuItem[] = [
	...
	},
	{
		...
		icon: Building2,
		children: [
			{ title: 'Dashboard', href: '/core-tenancy', icon: LayoutDashboard },
		],
	},
	{
		title: 'CRM – Clientes',
	...
	},
	{
		...
		children: [
			...
			{ title: 'Faturas', href: '/vendas/faturas', icon: Receipt },
			{
				...
				href: '/vendas/notas-credito',
				icon: RotateCcw,
			},
			{
				title: 'Notas de Débito',
				href: '/vendas/notas-debito',
				icon: AlertCircle,
			},
	...
	},
	{
		...
		children: [
			...
			{ title: 'Tickets', href: '/tickets/lista', icon: Ticket },
			{
				...
				href: '/tickets/base-conhecimento',
				icon: BookText,
			},
			{
				title: 'Relatórios',
				href: '/tickets/relatorios',
				icon: FileSpreadsheet,
			},
		],
	},
	...
	},
	{
		...
		icon: LineChart,
		children: [
			{ title: 'Dashboard', href: '/analytics', icon: LayoutDashboard },
		],
	},
	{
			...
			return (
				<div key={item.title}>
					<Button
						variant='ghost'
						className={cn(
							// min-w-0 para permitir o texto encolher, e o conteúdo não ir para baixo da scrollbar
							'w-full justify-start items-center h-10 pl-3 pr-4 hover:bg-[#1877F2] hover:text-white transition-colors group min-w-0',
					...
					>
						...
						{/* min-w-0 + truncate para o texto ceder espaço ao Chevron */}
						...
						{item.badge && (
							<Badge
								variant='secondary'
								className='ml-2 text-xs bg-[#1877F2]/30 border-0 group-hover:bg-white/20 flex-shrink-0'
							>
								{item.badge}
							</Badge>
						)}
	...
	return (
		...
		>
			...
			<ScrollArea className='flex-1 px-2 py-4'>
				{/* ESTA DIV CRIA O "GUTTER" PARA FUGIR DA SCROLLBAR */}
				<div className='pr-10'>
